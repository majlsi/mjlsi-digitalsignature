...
import { Languages } from '../../core/models/enums/languages';
...
export class PagesComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		if(this.route.snapshot.queryParams.lang && Object.values(Languages).includes(this.route.snapshot.queryParams.lang)){
			this.translate.setDefaultLang(this.route.snapshot.queryParams.lang);
		}
	}
